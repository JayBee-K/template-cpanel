;(function ($) {
    ...
    let handleCollapseSidebar = function () {
        ...
        folderCollapse.find('.folders-item').children(".folders-list").map(function () {
            let elm = $(this);
            elm.on('hidden.bs.collapse', function (e) {
                e.stopPropagation();
        ...
        if (windowWidth < 991) {
            $('#toolbar-folder').click(function () {
                $('#folder-collapse').toggleClass('is-show');
            });

            $('#manage-overlay').click(function () {
                if($('#folder-collapse').hasClass('is-show')) {
                    $('#folder-collapse').removeClass('is-show');
                }
            })
        }
    }
